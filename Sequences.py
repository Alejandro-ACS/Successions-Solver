...
def simplificar():
    ...
    try:
        ...
        simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[12]/div[2]/span').text

    except:

        try:

            simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[12]/div[2]/div/span').text
        except:

            try:

                simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[11]/div[2]/div/span').text
            
            except:

                try:

                    simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[11]/div[2]/span').text

                except:

                    try:

                        simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[10]/div[2]/div/span').text

                    except:

                        try:

                            simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[10]/div[2]/span').text

                        except:

                            try:

                                simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[9]/div[2]/span').text

                            except:

                                try:

                                    simplificar = browser.find_element_by_xpath('//*[@id="steps-container"]/li[9]/div[2]/div/span').text
...
if len(sucesion) >= 2:
    ...
    browser = webdriver.Chrome(executable_path="./whatsappbot/chromedriver")
...
print("- Sucesión simple -")

print("-------------------")

print(operacionE + "\n")

print("- Sucesión compleja -")
